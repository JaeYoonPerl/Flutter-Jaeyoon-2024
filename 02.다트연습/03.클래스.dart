...
void main(){
  // Dog클래스 메모리에 생성하기
  // 클래스를 담는 변수의 형은 그 클래스 명을 사용한다.
  // Dog d1 = new Dog(); -> 기본적으로 new로 인스턴스객체를
  // 생성하지만 이를 생략할 수 있다. (자동new)
  Dog d1 = Dog();
  print('나의 강아지 종류의 이름은 ${d1.name}이다!');
  // 클래스에 속성값 업데이트 하기
  d1.name='닥스훈트';
  print('1년 후 나의 추가한 강아지 종류의 이름은 ${d1.name}이다!');
